...
namespace Arca
{
    public partial class Form1 : Form
    {
        ...
        public static Brush brush = (Brush)Brushes.White;
        ...
        {
            pictures = new Bitmap[imagepath.Count];
        ...
        private void WaveOutDevice_PlaybackStopped(object sender, NAudio.Wave.StoppedEventArgs e)
        {
            ...
            {
                Task.Run(() => FadeIn(pictureBox1, pictures[inc - 1]));
            }
            else
            {
                waveOutDevice = new NAudio.Wave.WaveOut();
        ...
        private void FadeIn(PictureBox control, Image img)
        {
            Image oldimage = null;
        ...
        public void Start()
        {
            while (!closed)
            {
                try
                {
                    ...
                    graphics.FillRectangle(brush, 0 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar1, width / 20 / 2f - 1, bar1);
                    graphics.FillRectangle(brush, 1 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar2, width / 20 / 2f - 1, bar2);
                    graphics.FillRectangle(brush, 2 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar3, width / 20 / 2f - 1, bar3);
                    graphics.FillRectangle(brush, 3 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar4, width / 20 / 2f - 1, bar4);
                    graphics.FillRectangle(brush, 4 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar5, width / 20 / 2f - 1, bar5);
                    graphics.FillRectangle(brush, 5 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar6, width / 20 / 2f - 1, bar6);
                    graphics.FillRectangle(brush, 6 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar7, width / 20 / 2f - 1, bar7);
                    graphics.FillRectangle(brush, 7 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar8, width / 20 / 2f - 1, bar8);
                    graphics.FillRectangle(brush, 8 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar9, width / 20 / 2f - 1, bar9);
                    graphics.FillRectangle(brush, 9 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar10, width / 20 / 2f - 1, bar10);
                    graphics.FillRectangle(brush, 10 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar11, width / 20 / 2f - 1, bar11);
                    graphics.FillRectangle(brush, 11 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar12, width / 20 / 2f - 1, bar12);
                    graphics.FillRectangle(brush, 12 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar13, width / 20 / 2f - 1, bar13);
                    graphics.FillRectangle(brush, 13 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar14, width / 20 / 2f - 1, bar14);
                    graphics.FillRectangle(brush, 14 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar15, width / 20 / 2f - 1, bar15);
                    graphics.FillRectangle(brush, 15 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar16, width / 20 / 2f - 1, bar16);
                    graphics.FillRectangle(brush, 16 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar17, width / 20 / 2f - 1, bar17);
                    graphics.FillRectangle(brush, 17 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar18, width / 20 / 2f - 1, bar18);
                    graphics.FillRectangle(brush, 18 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar19, width / 20 / 2f - 1, bar19);
                    graphics.FillRectangle(brush, 19 * width / 20f / 2f + 0.5f + width / 4f, height - 300 - bar20, width / 20 / 2f - 1, bar20);
                    graphics.FillRectangle(brush, 0 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar1);
                    graphics.FillRectangle(brush, 1 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar2);
                    graphics.FillRectangle(brush, 2 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar3);
                    graphics.FillRectangle(brush, 3 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar4);
                    graphics.FillRectangle(brush, 4 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar5);
                    graphics.FillRectangle(brush, 5 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar6);
                    graphics.FillRectangle(brush, 6 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar7);
                    graphics.FillRectangle(brush, 7 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar8);
                    graphics.FillRectangle(brush, 8 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar9);
                    graphics.FillRectangle(brush, 9 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar10);
                    graphics.FillRectangle(brush, 10 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar11);
                    graphics.FillRectangle(brush, 11 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar12);
                    graphics.FillRectangle(brush, 12 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar13);
                    graphics.FillRectangle(brush, 13 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar14);
                    graphics.FillRectangle(brush, 14 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar15);
                    graphics.FillRectangle(brush, 15 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar16);
                    graphics.FillRectangle(brush, 16 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar17);
                    graphics.FillRectangle(brush, 17 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar18);
                    graphics.FillRectangle(brush, 18 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar19);
                    graphics.FillRectangle(brush, 19 * width / 20f / 2f + 0.5f + width / 4f, height - 300, width / 20 / 2f - 1, bar20);
                    if (fade)
                        graphics.DrawString(title[inc] + " By " + author[inc], new Font(FontFamily.GenericMonospace, 20, FontStyle.Bold), Brushes.White, new Rectangle(0, 0, width, height), sf);
                    Image oldimage = null;
